...
echo "=== Creating Ionic + Cordova project (tabs template, NON-standalone) ==="
...
echo "=== Replacing src/app/tab1/tab1.page.html with modern UI ==="
...
echo "=== Replacing src/app/tab1/tab1.page.ts (NON-standalone) ==="
...
git init
git add .
git commit -m "Initial Ionic + Cordova MozzartApp (tabs, NON-standalone) ready for Appflow"
git branch -M main
git remote add origin https://MarkoPetr@github.com/MarkoPetr/MozzartApp.git
git push -u origin main --force

echo "=== DONE! Ionic Cordova MozzartApp (tabs) final is ready for Appflow ==="
